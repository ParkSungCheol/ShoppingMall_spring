...
public class GoodsController {
    ...
    @Transactional(value="txManager")
    public List<Statistic> getStatisticData (@RequestParam Map<String, String> param) throws IOException {
		return elasticsearchService.getStatisticData(param.get("searchValue"));
    }
}
